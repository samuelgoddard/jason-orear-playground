...
export default function App({ Component, pageProps }) {
  ...
  return (
    <>
      <div className={`fixed top-0 left-0 w-full z-50 pt-6 px-6 transition ease-in-out duration-500 ${ router.pathname != '/about'  ? 'text-black delay-200' : 'text-white delay-1000' }`}>
      ...
      <div className={`fixed bottom-0 left-0 w-full z-50 pb-6 px-6`}>
        <div className="w-full overflow-hidden">
          <div className={`flex flex-wrap justify-end transition ease-in-out duration-500 transform ${ router.pathname != '/about'  ? 'translate-y-0 delay-1000' : 'translate-y-12 delay-100' }`}>
